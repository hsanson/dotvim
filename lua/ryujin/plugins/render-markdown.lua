return {
  ...
  config = function()
    ...
    vim.api.nvim_set_hl(0, "RenderMarkdownH1Bg", { fg = "#FFFFFF", bg = purple, blend = 10 })
    vim.api.nvim_set_hl(0, "RenderMarkdownH2Bg", { fg = "#FFFFFF", bg = purple, blend = 10 })
    vim.api.nvim_set_hl(0, "RenderMarkdownH3Bg", { fg = "#FFFFFF", bg = purple, blend = 10 })
    vim.api.nvim_set_hl(0, "RenderMarkdownH4Bg", { fg = "#FFFFFF", bg = purple, blend = 10 })
    vim.api.nvim_set_hl(0, "RenderMarkdownH5Bg", { fg = "#FFFFFF", bg = purple, blend = 10 })
    vim.api.nvim_set_hl(0, "RenderMarkdownH6Bg", { fg = "#FFFFFF", bg = purple, blend = 10 })
    ...
    vim.api.nvim_set_hl(0, "RenderMarkdownBullet", { fg = purple })
  end,
}
