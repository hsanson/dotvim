return {
  ...
  config = function()
    ...
    require("ale").setup({
      ...
      disable_lsp = "auto",
      sign_info = g.symbol_info,
      sign_error = g.symbol_error,
      sign_warning = g.symbol_warn,
      sign_priority = 4,
      open_list = 0,
      echo_msg_format = "%severity% [%linter%] (%code%) - %s",
      echo_msg_info_str = g.symbol_info,
      echo_msg_error_str = g.symbol_error,
      echo_msg_warning_str = g.symbol_warn,
